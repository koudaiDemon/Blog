    ...
    <ul class="am-nav am-nav-pills am-topbar-nav">
      ...
      <li class="am-dropdown" data-am-dropdown>
        ...
        <ul class="am-dropdown-content">
          <li><a href="lw-index.jsp">1. blog-index-standard</a></li>         
          <li><a href="lw-index-nosidebar.jsp">2. blog-index-nosidebar</a></li>
          <li><a href="lw-index-center.jsp">3. blog-index-layout</a></li>
          <li><a href="lw-index-noslider.jsp">4. blog-index-noslider</a></li>
        </ul>
      </li>
      <li><a href="lw-article.jsp">标准文章</a></li>
      <li><a href="lw-img.jsp">图片库</a></li>
      <li><a href="lw-article-fullwidth.jsp">全宽页面</a></li>
      <li><a href="lw-timeline.jsp">存档</a></li>
    </ul>
...
<div class="am-g am-g-fixed blog-fixed am-u-sm-centered blog-article-margin">
    ...
    <ul id="notice" class="am-slides">
      <li>
            <img src="assets/i/b1.jpg">
            <div class="blog-slider-desc am-slider-desc ">
                <div class="blog-text-center blog-slider-con">
                    <span><a href="" class="blog-color">Article &nbsp;</a></span>               
                    <h1 class="blog-h-margin"><a href="">长风破浪会有时</a></h1>
                    <p>蜀道难，难于上青天。蜀道难，难于上青天。
                    </p>
                    <span class="blog-bor">2017/9/9</span>
      ...
      <li>
            ...
            <div class="am-slider-desc blog-slider-desc">
                <div class="blog-text-center blog-slider-con">
                    <span><a href="" class="blog-color">Article &nbsp;</a></span>               
                    <h1 class="blog-h-margin"><a href="">直挂云帆济沧海</a></h1>
                    <p>让我留下眼泪的，不止昨夜的酒。让我依依不舍的，不止你的温柔！
                    </p>
                    <span>2017/7/9</span>                
                </div>
            </div>
      ...
      <li>
            ...
            <div class="am-slider-desc blog-slider-desc">
                <div class="blog-text-center blog-slider-con">
                    <span><a href="" class="blog-color">Article &nbsp;</a></span>               
                    <h1 class="blog-h-margin"><a href="">廉颇老矣，尚能饭否</a></h1>
                    <p>四十三年，望中犹记，烽火扬州路。凭谁问，廉颇老矣，尚能饭否！
                    </p>
                    <span>2017/9/8</span>                
                </div>
            </div>
      ...
      <li>
            ...
            <div class="am-slider-desc blog-slider-desc">
                <div class="blog-text-center blog-slider-con">
                    <span><a href="" class="blog-color">Article &nbsp;</a></span>               
                    <h1 class="blog-h-margin"><a href="">左牵狼，右擎瑲</a></h1>
...
// $.get('/blog/list',{'flag':'notice','cp':'1'},function(data){
// 	console.info(data);
// // 	var basePath = 'http://192.168.46.13:8080/imageDB/';
// 	load(data.list);
		
// 		li += '<li>';
// 		li += '<img src="assets/i/b3.jpg">';
...
// 		li += '<span class="blog-bor">2017/5/8</span>';
...
// 		li += '<div class="blog-text-center blog-slider-con">';
// 		li += '<span><a href="" class="blog-color">Article &nbsp;</a></span>';
// 		li += '<h1 class="blog-h-margin"><a href="">标题</a></h1>';
// 		li += '<br>那时候刚好下着雨，柏油路面湿冷冷的，还闪烁着青、黄、红颜色的灯火。</br>';
// 		li += '<span class="blog-bor">2017/5/8</span>';
// 		li += '</div>';
// 		li += '</div>';
// 		li += '</li>';
