...
<%@page import="com.softeem.dto.Category"%>
...
<title>修改栏目 - SOFTEEM博客管理系统</title>
...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <form action="doUpdate?flag=category&id=${category.id }" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" id="category-alias" name="alias" value="${category.vname }" class="form-control" placeholder="在此处输入栏目别名" required autocomplete="off">
...
<!--             <option value="5">程序人生</option> -->
        ...
        <div class="form-group">
          ...
          <input type="text" id="category-keywords" name="keywords" value="${category.keywords }" class="form-control" placeholder="在此处输入栏目关键字" autocomplete="off">
...
goPageLoginInfo(1,'<%=((Manager)session.getAttribute("manager")).getId()%>');
	$(function(){
		...
		$.get('list',{'flag':'category-type'},function(data){
			var pid = <%=((Category)request.getAttribute("category")).getPid()%>
			if(pid == 0){
