...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="doAdd?flag=notice&mid=${manager.id }" method="post" id="addNoticeInfo" class="add-article-form" enctype="multipart/form-data">
          <div class="col-md-9">
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <p><label>发布于：</label><span class="article-time-display"><input id="nowTime" style="border: none;" type="datetime" name="time" value="" /></span></p>
              </div>
